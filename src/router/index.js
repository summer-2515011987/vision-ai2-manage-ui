    ...
    },
    {
        ...
        children: [{
...

            {
                ...
                component: () =>
                    import ("@/views/systManagement/businessManagement"),
                meta: { title: "企业管理" }
            },
            {
                ...
                component: () =>
                    import (
                        "@/views/systManagement/businessManagement/components/createEnterprise"
                    ),
                meta: { title: "创建新企业" }
            },
            {
                ...
                name: "userManagement",
                component: () =>
                    import ("@/views/systManagement/userManagement"),
                meta: { title: "用户管理" }
            },
            {
                ...
                name: "roleManagement",
                component: () =>
                    import ("@/views/systManagement/roleManagement"),
                meta: { title: "角色管理" }
            },
            {
            ...
            },
            {
                ...
                name: "addMenu",
                component: () =>
                    import ("@/views/menuManagement/add"),
                meta: { title: "添加菜单" }
            },
            {
                ...
                name: "updateMenu",
                component: () =>
                    import ("@/views/menuManagement/update"),
                meta: { title: "编辑菜单" }
            },
            {
                path: "/home/logIn",
                name: "logIn",
                component: () =>
                    import ("@/views/logManagement/logIn"),
                meta: { title: "登陆日志" }
            },
            {
                ...
                name: "roleManagement",
                component: () =>
                    import ("@/views/logManagement/operationLog"),
                meta: { title: "操作日志" }
            },
            {
                ...
                name: "receivingLog",
                component: () =>
                    import ("@/views/logManagement/receivingLog"),
                meta: { title: "接口日志" }
            }
        ]
    },
